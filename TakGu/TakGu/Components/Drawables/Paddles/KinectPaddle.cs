...
namespace TakGu
{
    ...
    /// </summary>
    public class KinectPaddle : Paddle
    {
        private float width;
        ...
        public KinectPaddle(Game game, Texture2D texture, Texture2D textureActive, Vector3 position, Vector3 normal, Vector3 up, float width, float height, float textureSize, SoundEffect sound, float speed, float xBound, float yBound)
